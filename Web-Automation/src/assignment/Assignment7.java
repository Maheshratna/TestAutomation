...
public class Assignment7 {
	...
	static void createcustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("corejava");
			Thread.sleep(2000);
	...
	static void createtask()
	{
		try
		{
			...
			Thread.sleep(3000);
			oBrowser.findElement(By.xpath( "//*[@id=\"createTasksPopup_createTasksTableContainer\"]/table/tbody/tr[1]/td[1]/input")).sendKeys("assignment");
			Thread.sleep(3000);
