...
public static WebDriver oBrowser=null;
	...
	static void modifycustomer()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("modifycreatedcustomer")).sendKeys("objectmap scenario");
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("savemodifyedcustomer")).click();
			Thread.sleep(1000);
