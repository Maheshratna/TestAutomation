...
public static WebDriver oBrowser=null;
	...
	static void modifyuser()
	{
		try
		{
			...
			Thread.sleep(1000);
			oBrowser.findElement(objectmap.getLocator("modifypasswordfield")).sendKeys("123");
			oBrowser.findElement(objectmap.getLocator("retypemodifyedpasswordfield")).sendKeys("123");
			oBrowser.findElement(objectmap.getLocator("savemodifyeduserpage")).click();
			Thread.sleep(1000);
