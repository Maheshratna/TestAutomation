...
public class Assignment7 {
	...
	static void createtasks()
	{
		try
		{
			...
			Thread.sleep(2000);
			oPage.getnewTasks().click();
			Thread.sleep(2000);
			oPage.getenternameoftasks().sendKeys("Manual project");
			Thread.sleep(2000);
			oPage.getsavetasks().click();
			Thread.sleep(3000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	static void deletetasks()
	{
		try
		{
			...
			Thread.sleep(3000);
			oPage.getclickactionTask().click();
			Thread.sleep(3000);
			oPage.getclickOkDelete().click();
			Thread.sleep(3000);
			oPage.getDeleteTasks().click();
			Thread.sleep(3000);
		}catch(Exception e)
